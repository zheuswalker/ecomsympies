            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-heading">
                    <div class="panel-heading-btn">
                        ...
                        <a class="btn btn-xs btn-success" href="{{action('manageUsers@index')}}"><i class="fa fa-list"></i> List </a>
            ...
            <!-- end alert -->
                ...
                <div class="panel-body">
                    <div class="panel-body panel-form">
                        <form method="post" id="taxModal" action="{{action('manageUsers@store')}}"  enctype="multipart/form-data">
                            {{csrf_field()}}
